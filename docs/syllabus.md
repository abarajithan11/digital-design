# Syllabus - CSE140 Summer Session 1, 2026
...
| **100%** | **Total** |
| -2% | <a id="missed_session">__Per each missed session__ (if any in-class quiz was not answered) |
| +0.5% | <a id="unused_late_day"></a>_Per unused late day_ |
